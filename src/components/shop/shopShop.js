...
class ShopShop extends Component {
  state = {
      ...
      <div className="space-background">
        ...
        <div className="jumbotron shopDiv">
          <h3 className="color-black orange-background">
            {" "}
            {this.props.playerLocation} Shoppe
          </h3>
          ...
          <hr className="my-4" />
          <h4 className="color-white blue-background">{this.props.shopNames}</h4>
