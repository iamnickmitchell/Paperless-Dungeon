...
class ShopClothing2 extends Component {
  state = {
      ...
      <div className="space-background">
        ...
        <div className="jumbotron shopDiv">
          <h3 className="color-black orange-background">
            {" "}
            {this.props.playerLocation} Outfitter
          </h3>
          ...
          <hr className="my-4" />
          <h4 className="color-white blue-background">{this.props.clothingNames}</h4>
