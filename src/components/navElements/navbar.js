...
class NavBar extends Component {
    render() {
        return (
            ...
            <p className="footerLogo logo"> Paperless Dungeon <a href="https://github.com/iamnickmitchell/Paperless-Dungeon" target="_blank" rel="noopener noreferrer">v.1.0.3.9_alpha</a>  &#169;2019</p>
            </div>
        )
    }
}
